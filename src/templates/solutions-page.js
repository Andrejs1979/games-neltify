...
export const SolutionsPageTemplate = ({ image, heading, subheading, sections, blurbs, final }) => (
	<div>
...
export const pageQuery = graphql`
	query SolutionPageByID {
		markdownRemark(frontmatter: { templateKey: { eq: "solutions-page" } }) {
			frontmatter {
				title
				heading
				subheading
