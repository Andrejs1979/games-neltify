...
export const SmallBusinessPageTemplate = ({ image, heading, subheading, sections, blurbs, final }) => (
	<div>
...
export const smallBusinessPageQuery = graphql`
